		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t033",targetState="ready",cond=whenDispatch("turn_on"))
				}	 
				state("ready") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t134",targetState="burn_rp",cond=whenDispatch("burn_in"))
				}	 
				state("burn_rp") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t135",targetState="get_ash",cond=whenDispatch("get_ash"))
				}	 
