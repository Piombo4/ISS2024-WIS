...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     ash_storage >> Edge(color='blue', style='solid',  decorate='true', label='<test &nbsp; >',  fontcolor='blue') >> tester
     ...
     tester >> Edge(color='blue', style='solid',  decorate='true', label='<waste_in &nbsp; >',  fontcolor='blue') >> waste_storage
